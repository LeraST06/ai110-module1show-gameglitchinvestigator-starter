...
One habit I want to keep is asking AI to explain the bug and its cause before jumping to a fix. Next time I would also ask it to write comments in the code so I don't forget what each fix does later. Honestly, my view of AI-generated code hasn't changed much since I already use AI tools a lot, but this was my first time using Claude Code directly inside VS Code and it saved a A LOT time by just having it "in-built". 
